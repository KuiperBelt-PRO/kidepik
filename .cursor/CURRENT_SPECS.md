...
- **Progreso por materia — Opción B lineal (implementada 16 ago 2026):** [specify/SPEC_APP_SUBJECT_PROGRESS_LINEAR_B.md](specify/SPEC_APP_SUBJECT_PROGRESS_LINEAR_B.md) — Δ 0.075 por acierto (~8% barra), umbral rolling 1.0 (100%), 4 caminos × 3 retos para subir L; semilla 0.10
- **Recompensas + equipaje (aprobada — implementada parcialmente ago 2026):** economía [SPEC_APP_REWARDS_ECONOMY](specify/SPEC_APP_REWARDS_ECONOMY.md) (grants en retos/caminos), inventario [SPEC_APP_INVENTORY_BAGGAGE](specify/SPEC_APP_INVENTORY_BAGGAGE.md), catálogo [SPEC_APP_ITEM_CATALOG](specify/SPEC_APP_ITEM_CATALOG.md), efectos [SPEC_APP_REWARD_EFFECTS](specify/SPEC_APP_REWARD_EFFECTS.md) (hint/retry vía POST use), gasto futuro [SPEC_APP_REWARD_SPENDING](specify/SPEC_APP_REWARD_SPENDING.md); UI [SPEC_APP_CREW_BAGGAGE_TAB](specify/SPEC_APP_CREW_BAGGAGE_TAB.md) + [SPEC_APP_PLAY_BAGGAGE_TOGGLE](specify/SPEC_APP_PLAY_BAGGAGE_TOGGLE.md) + [SPEC_APP_PLAY_PROGRESS_HUD](specify/SPEC_APP_PLAY_PROGRESS_HUD.md); plan [tasks/REWARDS_BAGGAGE_IMPLEMENTATION_PLAN.md](tasks/REWARDS_BAGGAGE_IMPLEMENTATION_PLAN.md); diagrama [19-rewards-inventory](diagrams/19-rewards-inventory.md)
...
- **Placement adaptativo + prosa mentor:** [specify/SPEC_APP_MENTOR_PLACEMENT_ADAPTIVE.md](specify/SPEC_APP_MENTOR_PLACEMENT_ADAPTIVE.md) — **implementada** 31 jul 2026; **A1** (1 ago 2026): examen solo agente, sin banco seed; castellano ES; fallo → reintento; **§1.5 (18 ago):** conocimiento escolar previo vs lore del mundo; **§1.4.1 (19 ago):** suelo de banda + nivel de materia en compose
