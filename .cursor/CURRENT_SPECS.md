...
- **Mecánicas de viaje (aprobada ago 2026; delta consulta mentor 24 ago):** [specify/SPEC_APP_JOURNEY_MECHANICS.md](specify/SPEC_APP_JOURNEY_MECHANICS.md) — flujos espera / first-run / prueba / caminos / rangos; **§5.1b** compose en `choose_path` / `path_intro`.
- **Contexto tutor en caminos (implementada 15 ago 2026):** [specify/SPEC_APP_PATH_COMPOSER_TUTOR_CONTEXT.md](specify/SPEC_APP_PATH_COMPOSER_TUTOR_CONTEXT.md) — notas + ranking híbrido; **delta 19 ago:** suelo de banda + L*; **T11–T12:** instrucciones primero, validadores solo estructurales (sin reintento por cliché/paleta).
- **Path composer paralelo + reutilización (implementada 20 ago 2026):** [specify/SPEC_APP_PATH_COMPOSER_PARALLEL_REUSE.md](specify/SPEC_APP_PATH_COMPOSER_PARALLEL_REUSE.md) — 3 slots LLM en paralelo; tras completar camino reutilizar 2 descartados + 1 compose nuevo; logging `path_compose_path_parse_failed` con `issue`.
- **Equipaje inline en retos (implementada 15 ago 2026; delta 24 ago):** [specify/SPEC_APP_PLAY_CHALLENGE_BAGGAGE_OFFER.md](specify/SPEC_APP_PLAY_CHALLENGE_BAGGAGE_OFFER.md) — chips en pie del diálogo play; `baggage_offers[]` en open/turn/use; **B6:** copy de fallo menciona equipaje solo si hay oferta `can_use`.
- **Compose compacto play (implementada 21 ago 2026):** [specify/SPEC_APP_PLAY_COMPOSE_COMPACT.md](specify/SPEC_APP_PLAY_COMPOSE_COMPACT.md) — hotbar plegada por defecto; título de capítulo 2 líneas; chips MCQ en el log (umbral / rito / aventura); pie = compose.
...
- **Cuenta de tripulante (Gmail propio + rol crew):** [specify/SPEC_APP_CREW_MEMBER_ACCOUNT.md](specify/SPEC_APP_CREW_MEMBER_ACCOUNT.md) — **implementada 21 ago 2026** (D4: desvincular conserva el Gmail invitado); invita Gmail distinto al tutor; login Google → `role=crew`; menú Tripulante; desvincular sin borrar plaza
...
- **Ficha tripulante v2 (aprobada 15 ago 2026):** [specify/SPEC_APP_CREW_MEMBER_DETAIL.md](specify/SPEC_APP_CREW_MEMBER_DETAIL.md) (pestañas **Viaje / Progreso / Equipaje / Ajustes**), [specify/SPEC_APP_CREW_PROGRESS.md](specify/SPEC_APP_CREW_PROGRESS.md), [specify/SPEC_APP_CREW_MEMBER_SETTINGS.md](specify/SPEC_APP_CREW_MEMBER_SETTINGS.md), [specify/SPEC_APP_CREW_BAGGAGE_TAB.md](specify/SPEC_APP_CREW_BAGGAGE_TAB.md) — **delta 16 ago:** toggle tutor **En mochila / Gastados** + `usage_log[]` + badge **Usado N×**
- **Progreso por materia — Opción B lineal (implementada 16 ago 2026; rewind V2 20 ago):** [specify/SPEC_APP_SUBJECT_PROGRESS_LINEAR_B.md](specify/SPEC_APP_SUBJECT_PROGRESS_LINEAR_B.md) — Δ 0.075 por acierto (~8% barra), umbral rolling 1.0 (100%), 4 caminos × 3 retos para subir L; semilla 0.10; rewind post-placement **reconstruye** rolling (no borra la fila de placement)
- **Retos por camino configurables (implementada 23 ago 2026):** [specify/SPEC_APP_PATH_CHALLENGE_COUNT.md](specify/SPEC_APP_PATH_CHALLENGE_COUNT.md) — tutor elige N retos/camino (min 3, max 10; default 3 en early/child/senior, 5 en tween/teen/adult); `path_composer` genera exactamente N; Δ rolling = `0.90 / (4N)` por acierto (4 caminos llenan la barra)
- **Recompensas + equipaje (aprobada — implementada parcialmente ago 2026):** economía [SPEC_APP_REWARDS_ECONOMY](specify/SPEC_APP_REWARDS_ECONOMY.md) (grants en retos/caminos; **delta 20 ago:** `toast_child` nombra el hallazgo concreto primero), inventario [SPEC_APP_INVENTORY_BAGGAGE](specify/SPEC_APP_INVENTORY_BAGGAGE.md), catálogo [SPEC_APP_ITEM_CATALOG](specify/SPEC_APP_ITEM_CATALOG.md), efectos [SPEC_APP_REWARD_EFFECTS](specify/SPEC_APP_REWARD_EFFECTS.md) (hint/retry vía POST use), gasto futuro [SPEC_APP_REWARD_SPENDING](specify/SPEC_APP_REWARD_SPENDING.md); UI [SPEC_APP_CREW_BAGGAGE_TAB](specify/SPEC_APP_CREW_BAGGAGE_TAB.md) + [SPEC_APP_PLAY_BAGGAGE_TOGGLE](specify/SPEC_APP_PLAY_BAGGAGE_TOGGLE.md) + [SPEC_APP_PLAY_PROGRESS_HUD](specify/SPEC_APP_PLAY_PROGRESS_HUD.md); plan [tasks/REWARDS_BAGGAGE_IMPLEMENTATION_PLAN.md](tasks/REWARDS_BAGGAGE_IMPLEMENTATION_PLAN.md); diagrama [19-rewards-inventory](diagrams/19-rewards-inventory.md)
...
- **Diálogo de aventura (IA):** [specify/SPEC_APP_ADVENTURE_DIALOGUE.md](specify/SPEC_APP_ADVENTURE_DIALOGUE.md) — **implementada** jul 2026; toast, burbujas con icono, compose chat, tema por mundo; **§1.1c** consulta mentor en caminos (24 ago)
...
- **Catálogo de materias (14 áreas):** [specify/SPEC_APP_SUBJECT_CATALOG.md](specify/SPEC_APP_SUBJECT_CATALOG.md) — **implementada** 31 jul 2026; `reading` separada; base por banda; activación por tripulante en ficha; **delta 18 ago:** `mythology` = mitos reales (placement no examina lore inventado)
- **Placement adaptativo + prosa mentor:** [specify/SPEC_APP_MENTOR_PLACEMENT_ADAPTIVE.md](specify/SPEC_APP_MENTOR_PLACEMENT_ADAPTIVE.md) — **implementada** 31 jul 2026; **A1** (1 ago 2026): examen solo agente, sin banco seed; castellano ES; fallo → reintento; **§1.5 (18 ago):** conocimiento escolar previo vs lore del mundo; **§1.4.1 (19 ago):** suelo de banda + nivel de materia en compose; **§1.6 (20 ago):** calidad MCQ por instrucciones (anti-tautología); sin reintento pedagógico en compose
...
- **Modo debug IA (tutor / local):** [specify/SPEC_APP_DEBUG_MODE.md](specify/SPEC_APP_DEBUG_MODE.md) — **implementada**; permisos DB (`debug_ai` vía grupos `developers`/`admins`) + toggle sticky en `parent_accounts.settings`; panel UI + traza gateway
- **Rebobinado de viaje en debug (implementada ago 2026):** [specify/SPEC_APP_DEBUG_JOURNEY_REWIND.md](specify/SPEC_APP_DEBUG_JOURNEY_REWIND.md) — icono ↺ en burbujas play; trunca turnos/ledger posteriores; rolling de materias se **recalcula** (V2); solo tutor + local
...
- **Rangos de progresión (sci-fi / fantasía):** [specify/SPEC_APP_PROGRESSION_RANKS.md](specify/SPEC_APP_PROGRESSION_RANKS.md) — **marco** jul 2026; 5 tiers duales; hints tutor «Inicio del viaje» / «Cumbre del viaje» (ago 2026)
