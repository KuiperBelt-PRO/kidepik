# Spec: Portales mágicos — dolmen v1 + FX de apertura/cierre

> Estado: **aprobado e implementación v1** (jul 2026)  
...
## 1. Alcance v1 (esta iteración)

Un solo estilo: **`dolmen`** — dos rocas verticales y una losa horizontal.
...
**No objetivos v1:** `gateArch`, `runeRing`, `riftPortal`; interacción usuario; animar la silueta blanca de las rocas.
...
export function planPortalStyle(seed); // v1: siempre 'dolmen'
...
- 3 piezas con roles dolmen; build order uprights antes que lintel.
- `computePortalAperture` con área > 0.
- Receta FX válida, determinista, sin partículas obligatorias.
