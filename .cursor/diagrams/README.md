...
**Stack canónico (dev local):** Docker `:8082` + Supabase + FastAPI (play/IA) + PHP legado crew/settings según cutover. Media: `web/media/`. Ledger: `data/journey/`.
...
| 04 | [04-backend-php.md](04-backend-php.md) | API PHP (legado + cutover) |
