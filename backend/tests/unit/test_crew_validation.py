...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"learning": {"challenges_per_path": 0}}, "learning.challenges_per_path invalid"),
        ({"learning": {"challenges_per_path": 1}}, "learning.challenges_per_path invalid"),
        ({"learning": {"challenges_per_path": 2}}, "learning.challenges_per_path invalid"),
